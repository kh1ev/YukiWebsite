					...
					<div className="container mx-auto px-4 sm:px-6 lg:px-8 h-full min-h-screen flex flex-col lg:flex-row items-center justify-between relative z-10">
						...
						>
							...
							>
								...
								>
									<span className="text-gray-300">YUKI</span>
								</h2>
								<h2
								...
								>
									...
									<span className="text-xl align-top ml-1">TM</span>
								</h2>

								<p className="text-gray-400 text-lg leading-relaxed max-w-lg lg:mx-0 mx-auto mt-6">
									Indonesian ChatBot and minigame with fishing economy arc from
									Yuki Playground!
								</p>
							</motion.div>
							...
							>
								<Button
									size="lg"
									className="bg-gray-800 hover:bg-gray-700 text-white border border-gray-700 rounded-md px-8 py-2 text-sm transition-colors"
								>
									Invite
								</Button>
							</motion.div>
